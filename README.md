...
![Главный экран](images/main_ui.jpg)
...
### Навигация и профили
Доступ к системному меню, регулировке фазового сдвига и ячейкам памяти:

![Системное меню](images/menu_settings.jpg)
![Сохранение профиля](images/save_profile.jpg)
...
* **Zero-Cross Shift (Калибровка фазы):** 
  Настройка необходима для компенсации задержки обработки сигнала микроконтроллером и точного переноса старта импульса на следующую полуволну.
